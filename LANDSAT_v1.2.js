...
var thr_ANDVI = ee.Number(ANDVI.reduceRegion({reducer:ee.Reducer.percentile([25]),geometry:burned,tileScale: 16,scale:100}).get('ANDVI'));
...
var thr_NDVI = ee.Number(NDVI.reduceRegion({reducer:ee.Reducer.percentile([25]),geometry:burned,tileScale: 16,scale:100}).get('NDVI'));
...
var thr_ANIR = ee.Number(ANDVI.reduceRegion({reducer:ee.Reducer.percentile([1]),geometry:burned,tileScale: 16,scale:100}).get('ANDVI'));
...
var thr_NIR = ee.Number(NDVI.reduceRegion({reducer:ee.Reducer.percentile([1]),geometry:burned,tileScale: 16,scale:100}).get('NDVI'));
